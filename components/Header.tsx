...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <nav className="flex items-center justify-between w-full max-w-3xl px-4 sm:px-6 mx-auto sm:py-2 xl:max-w-5xl xl:px-0">
          <div className="order-2 sm:order-1">
            <a
              ...
              href="/"
            >
              <div className="horizontal-underline text-2xl font-semibold horizontal-underline-active">
                M.K.
              </div>
            </a>
          </div>
          <div className="order-1 sm:order-2 flex items-center text-base leading-5 ">
            <div className="hidden sm:block sm:space-x-8 mx-auto">
